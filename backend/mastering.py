...
def _apply_lookahead_shift(gr: np.ndarray, look_samples: int) -> np.ndarray:
    ...
    if look_samples <= 0 or len(gr) <= look_samples:
        return gr
    tail = np.full(look_samples, gr[-1], dtype=gr.dtype)
...
def dynamic_eq_band(audio: np.ndarray, sr: int,
    ...
    # ~125ms). Si esa ventana caía en silencio/fade-out/pasaje bajo, el
    # meter mostraba 0.0 dB de gr aunque el resto del track sí hubiera
    # tenido reducción. Ahora se promedia (y se reporta el pico) sobre
    # TODO el arreglo de gr, no solo el final.
    meter = {
        "bypass": False,
...
def analyze_audio(audio: np.ndarray, sr: int) -> dict:
    ...
    silencio) y densidad de transientes. Es el "input sensorial" que usa
...
MASTERING_PRESETS = {
    ...
    "cd": {
        ...
        "mb_low_threshold_db": -1.4, "mb_low_ratio": 1.4, "mb_low_attack_ms": 30.0, "mb_low_release_ms": 200.0, "mb_low_makeup_db": 0.0,
        "mb_mid_threshold_db": -1.4, "mb_mid_ratio": 1.4, "mb_mid_attack_ms": 20.0, "mb_mid_release_ms": 180.0, "mb_mid_makeup_db": 0.0,
        "mb_high_threshold_db": -1.4, "mb_high_ratio": 1.3, "mb_high_attack_ms": 10.0,  "mb_high_release_ms": 120.0,  "mb_high_makeup_db": 0.0,
    ...
    "edm": {
        ...
        "comp_threshold_db": -6.7, "comp_ratio": 2.8, "comp_attack_ms": 7.0, "comp_release_ms": 95.0, "comp_makeup_db": 1.6,
        "transient_attack": 0.17, "transient_sustain": -0.08,
        "mb_bypass": False,
        "mb_low_crossover": 100.0, "mb_high_crossover": 5000.0,
        "mb_low_threshold_db": -6.4, "mb_low_ratio": 2.6, "mb_low_attack_ms": 12.0, "mb_low_release_ms": 180.0, "mb_low_makeup_db": 0.8,
        "mb_mid_threshold_db": -4.2, "mb_mid_ratio": 1.9, "mb_mid_attack_ms": 8.0, "mb_mid_release_ms": 90.0, "mb_mid_makeup_db": 0.4,
        "mb_high_threshold_db": -3.5, "mb_high_ratio": 1.7, "mb_high_attack_ms": 5.0,  "mb_high_release_ms": 60.0,  "mb_high_makeup_db": 0.3,
    ...
    "techno": {
        ...
        "comp_threshold_db": -7.1, "comp_ratio": 2.8, "comp_attack_ms": 7.0, "comp_release_ms": 95.0, "comp_makeup_db": 1.6,
        "transient_attack": 0.13, "transient_sustain": -0.12,
        "mb_bypass": False,
        "mb_low_crossover": 90.0, "mb_high_crossover": 4500.0,
        "mb_low_threshold_db": -6.7, "mb_low_ratio": 2.8, "mb_low_attack_ms": 10.0, "mb_low_release_ms": 170.0, "mb_low_makeup_db": 0.9,
        "mb_mid_threshold_db": -4.4, "mb_mid_ratio": 1.9, "mb_mid_attack_ms": 8.0, "mb_mid_release_ms": 90.0, "mb_mid_makeup_db": 0.4,
        "mb_high_threshold_db": -3.7, "mb_high_ratio": 1.7, "mb_high_attack_ms": 5.0,  "mb_high_release_ms": 60.0,  "mb_high_makeup_db": 0.3,
    ...
    "rnb": {
        ...
        "comp_threshold_db": -4.4, "comp_ratio": 1.9, "comp_attack_ms": 15.0, "comp_release_ms": 145.0, "comp_makeup_db": 0.9,
        "transient_attack": 0.06, "transient_sustain": 0.05,
        "mb_bypass": False,
        "mb_low_crossover": 150.0, "mb_high_crossover": 3800.0,
        "mb_low_threshold_db": -4.4, "mb_low_ratio": 1.9, "mb_low_attack_ms": 22.0, "mb_low_release_ms": 160.0, "mb_low_makeup_db": 0.4,
        "mb_mid_threshold_db": -3.9, "mb_mid_ratio": 1.7, "mb_mid_attack_ms": 16.0, "mb_mid_release_ms": 130.0, "mb_mid_makeup_db": 0.4,
        "mb_high_threshold_db": -3.0, "mb_high_ratio": 1.5, "mb_high_attack_ms": 9.0,  "mb_high_release_ms": 90.0,  "mb_high_makeup_db": 0.2,
    ...
    "jazz": {
        ...
        "comp_threshold_db": -2.2, "comp_ratio": 1.4, "comp_attack_ms": 22.0, "comp_release_ms": 190.0, "comp_makeup_db": 0.3,
        "transient_attack": 0.0, "transient_sustain": 0.05,
        "mb_bypass": False,
        "mb_low_crossover": 180.0, "mb_high_crossover": 4000.0,
        "mb_low_threshold_db": -1.7, "mb_low_ratio": 1.3, "mb_low_attack_ms": 30.0, "mb_low_release_ms": 200.0, "mb_low_makeup_db": 0.0,
        "mb_mid_threshold_db": -1.5, "mb_mid_ratio": 1.3, "mb_mid_attack_ms": 22.0, "mb_mid_release_ms": 180.0, "mb_mid_makeup_db": 0.0,
        "mb_high_threshold_db": -1.3, "mb_high_ratio": 1.25, "mb_high_attack_ms": 12.0,  "mb_high_release_ms": 130.0,  "mb_high_makeup_db": 0.0,
    ...
    "classical": {
        ...
        "comp_threshold_db": -1.1, "comp_ratio": 1.25, "comp_attack_ms": 28.0, "comp_release_ms": 220.0, "comp_makeup_db": 0.0,
        "transient_attack": 0.0, "transient_sustain": 0.0,
        ...
        "mb_low_threshold_db": -0.9, "mb_low_ratio": 1.2, "mb_low_attack_ms": 40.0, "mb_low_release_ms": 250.0, "mb_low_makeup_db": 0.0,
        "mb_mid_threshold_db": -0.9, "mb_mid_ratio": 1.2, "mb_mid_attack_ms": 30.0, "mb_mid_release_ms": 220.0, "mb_mid_makeup_db": 0.0,
        "mb_high_threshold_db": -0.8, "mb_high_ratio": 1.15, "mb_high_attack_ms": 15.0,  "mb_high_release_ms": 150.0,  "mb_high_makeup_db": 0.0,
        "saturation_drive": 0.0, "saturation_mode": "tape", "saturation_mix": 0.0,
        "mid_gain_db": 0.0, "side_gain_db": 0.0, "stereo_width_amount": 1.0,
        "use_stereo_enhancer": False, "enhancer_bass_mono_freq": 120.0, "haas_delay_ms": 0.0,
    ...
    "lofi": {
        ...
        "comp_threshold_db": -4.4, "comp_ratio": 1.8, "comp_attack_ms": 18.0, "comp_release_ms": 150.0, "comp_makeup_db": 0.8,
        "transient_attack": 0.04, "transient_sustain": 0.16,
        "mb_bypass": False,
        "mb_low_crossover": 140.0, "mb_high_crossover": 3500.0,
        "mb_low_threshold_db": -3.9, "mb_low_ratio": 1.8, "mb_low_attack_ms": 25.0, "mb_low_release_ms": 170.0, "mb_low_makeup_db": 0.2,
        "mb_mid_threshold_db": -4.4, "mb_mid_ratio": 1.9, "mb_mid_attack_ms": 18.0, "mb_mid_release_ms": 140.0, "mb_mid_makeup_db": 0.4,
        "mb_high_threshold_db": -2.7, "mb_high_ratio": 1.4, "mb_high_attack_ms": 10.0,  "mb_high_release_ms": 100.0,  "mb_high_makeup_db": 0.0,
    ...
    "acoustic": {
        ...
        "eq4_freq": 9000.0, "eq4_gain": 1.2, "eq4_q": 0.9,
        "comp_threshold_db": -3.3, "comp_ratio": 1.7, "comp_attack_ms": 18.0, "comp_release_ms": 160.0, "comp_makeup_db": 0.6,
        "transient_attack": 0.04, "transient_sustain": 0.08,
        "mb_bypass": False,
        "mb_low_crossover": 160.0, "mb_high_crossover": 4000.0,
        "mb_low_threshold_db": -2.9, "mb_low_ratio": 1.6, "mb_low_attack_ms": 28.0, "mb_low_release_ms": 190.0, "mb_low_makeup_db": 0.2,
        "mb_mid_threshold_db": -2.6, "mb_mid_ratio": 1.5, "mb_mid_attack_ms": 18.0, "mb_mid_release_ms": 150.0, "mb_mid_makeup_db": 0.2,
        "mb_high_threshold_db": -2.2, "mb_high_ratio": 1.4, "mb_high_attack_ms": 10.0,  "mb_high_release_ms": 110.0,  "mb_high_makeup_db": 0.1,
    ...
    "indie": {
        ...
        "comp_threshold_db": -4.4, "comp_ratio": 2.0, "comp_attack_ms": 14.0, "comp_release_ms": 135.0, "comp_makeup_db": 0.9,
        "transient_attack": 0.09, "transient_sustain": 0.04,
        "mb_bypass": False,
        "mb_low_crossover": 160.0, "mb_high_crossover": 4000.0,
        "mb_low_threshold_db": -3.9, "mb_low_ratio": 1.8, "mb_low_attack_ms": 24.0, "mb_low_release_ms": 155.0, "mb_low_makeup_db": 0.3,
        "mb_mid_threshold_db": -3.6, "mb_mid_ratio": 1.7, "mb_mid_attack_ms": 15.0, "mb_mid_release_ms": 125.0, "mb_mid_makeup_db": 0.3,
        "mb_high_threshold_db": -3.1, "mb_high_ratio": 1.5, "mb_high_attack_ms": 8.0,  "mb_high_release_ms": 90.0,  "mb_high_makeup_db": 0.2,
    ...
    "cumbia": {
        ...
        "comp_threshold_db": -5.7, "comp_ratio": 2.4, "comp_attack_ms": 10.0, "comp_release_ms": 110.0, "comp_makeup_db": 1.3,
        "transient_attack": 0.15, "transient_sustain": -0.02,
        "mb_bypass": False,
        "mb_low_crossover": 115.0, "mb_high_crossover": 4200.0,
        "mb_low_threshold_db": -5.4, "mb_low_ratio": 2.2, "mb_low_attack_ms": 17.0, "mb_low_release_ms": 165.0, "mb_low_makeup_db": 0.5,
        "mb_mid_threshold_db": -4.4, "mb_mid_ratio": 1.9, "mb_mid_attack_ms": 11.0, "mb_mid_release_ms": 115.0, "mb_mid_makeup_db": 0.4,
        "mb_high_threshold_db": -3.6, "mb_high_ratio": 1.7, "mb_high_attack_ms": 6.0,  "mb_high_release_ms": 80.0,  "mb_high_makeup_db": 0.3,
    ...
    "funk": {
        ...
        "eq4_freq": 9000.0, "eq4_gain": 1.6, "eq4_q": 0.8,
        "comp_threshold_db": -5.4, "comp_ratio": 2.3, "comp_attack_ms": 8.0, "comp_release_ms": 95.0, "comp_makeup_db": 1.2,
        "transient_attack": 0.14, "transient_sustain": 0.02,
        "mb_bypass": False,
        "mb_low_crossover": 130.0, "mb_high_crossover": 4200.0,
        "mb_low_threshold_db": -5.0, "mb_low_ratio": 2.1, "mb_low_attack_ms": 14.0, "mb_low_release_ms": 140.0, "mb_low_makeup_db": 0.4,
        "mb_mid_threshold_db": -4.4, "mb_mid_ratio": 1.9, "mb_mid_attack_ms": 9.0, "mb_mid_release_ms": 100.0, "mb_mid_makeup_db": 0.4,
        "mb_high_threshold_db": -3.6, "mb_high_ratio": 1.7, "mb_high_attack_ms": 5.0,  "mb_high_release_ms": 70.0,  "mb_high_makeup_db": 0.3,
    ...
    "podcast": {
        ...
        "mb_bypass": True,
        "mb_low_crossover": 200.0, "mb_high_crossover": 4000.0,
        "mb_low_threshold_db": -3.1, "mb_low_ratio": 1.8, "mb_low_attack_ms": 20.0, "mb_low_release_ms": 150.0, "mb_low_makeup_db": 0.0,
        "mb_mid_threshold_db": -3.1, "mb_mid_ratio": 1.8, "mb_mid_attack_ms": 15.0, "mb_mid_release_ms": 130.0, "mb_mid_makeup_db": 0.0,
        "mb_high_threshold_db": -2.5, "mb_high_ratio": 1.6, "mb_high_attack_ms": 8.0,  "mb_high_release_ms": 90.0,  "mb_high_makeup_db": 0.0,
        "saturation_drive": 0.0, "saturation_mode": "tape", "saturation_mix": 0.0,
        "mid_gain_db": 0.0, "side_gain_db": 0.0, "stereo_width_amount": 1.0,
        "use_stereo_enhancer": False, "enhancer_bass_mono_freq": 120.0, "haas_delay_ms": 0.0,
...
def compressor(audio: np.ndarray, sr: int,
    ...
    rms_window_ms: pre-suaviza el detector con una ventana RMS corta antes
        ...
        en vez de peak puro). 0 = comportamiento anterior (peak puro).
    ...
    def gain_reduction(abs_signal):
        if ovs > 1:
            ...
            look_up = int(round(sr_up * lookahead_ms / 1000.0))
            gr_db_up = _apply_lookahead_shift(gr_db_up, look_up)
...
def apply_mastering_chain(
    ...
    **_ignored,
    ...
    audio_pre_comp = audio.copy() if (not parallel_bypass and parallel_mix > 0.0) else None
